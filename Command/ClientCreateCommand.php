...
namespace Redking\Bundle\OAuthBundle\Command;
...
{  
    ...
    {  
        $this  
            ->setName('redking:oauth-server:client:create')  
    ...
    {  
        ...
        $output->writeln(sprintf('Added a new client with name  : <info>%s</info>'."\n".'public id  : <info>%s</info>'."\n".'secret : <info>%s</info>', $client->getName(), $client->getPublicId(), $client->getSecret()));          
    }  
}
